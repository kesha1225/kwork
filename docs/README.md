...
- несколько удобных “высокоуровневых” методов (pydantic-модели), например `get_me()`, `get_projects()` и т.д.
...
И “сырьевые” методы, которые возвращают `dict`:
...
- соблюдай правила/лимиты площадки
